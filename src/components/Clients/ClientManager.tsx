      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs">
        <div>
          <h2 className="text-xl font-bold text-slate-900 flex items-center gap-2">
            ...
            <span>Gestion des Clients ({clients.length})</span>
          </h2>
      ...
      {filteredClients.length === 0 ? (
        <div className="text-center py-12 bg-white rounded-2xl border border-slate-200/80 p-6">
          ...
          {!searchTerm && categoryFilter === 'all' && (
            <button
              onClick={handleAddNew}
              className="mt-4 px-4 py-2 bg-blue-600 text-white rounded-xl font-medium text-xs cursor-pointer inline-flex items-center gap-2"
            >
              <Plus className="w-4 h-4" />
              ...
              >
                <div>
                  ...
                  <div className="flex items-center justify-between gap-2 mb-3">
                    ...
                    >
                      {isEntreprise ? <Building className="w-3 h-3 text-blue-600" /> : <User className="w-3 h-3 text-blue-600" />}
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    <div
                      className={`w-10 h-10 rounded-xl flex items-center justify-center font-bold text-sm shrink-0 ${
                        isEntreprise ? 'bg-blue-100/70 text-blue-800' : 'bg-blue-100/70 text-blue-800'
                      }`}
                    >
                ...
                <div className="flex items-center gap-2 pt-3 border-t border-slate-100">
                  <button
                    ...
                    className="flex-1 py-1.5 px-2 bg-blue-50 hover:bg-blue-100 text-blue-700 font-semibold rounded-lg text-xs transition-colors text-center cursor-pointer flex items-center justify-center gap-1"
                  >
                    <span>+ Facture</span>
                  </button>
                  <button
